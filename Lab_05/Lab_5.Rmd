...
- **Ciclo de vida:** anual de inverno - prostrada

- **Cotilédone** ovado

- **Folha:** pequena, em forma de ovo com uma ponta pontiaguda, opostos

- **Flores:** 5 pétalas brancas com fendas profundas que podem levar você a acreditar que são 10

- **Caule:** Pubescente - uma única linha de pelos - correndo ao longo do comprimento do caule
...
```{r echo=FALSE, out.width=300, fig.align='center'}
knitr::include_graphics("https://www.minnesotawildflowers.info/udata/r9ndp23q/pd/mollugo-verticillata-12948.jpg")
``` 
]
